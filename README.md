...
Resmi Versiyon: ALPHA 1.0.0 | Geliştirici: Farmant Studios
...
Prosedürel Bitki Örtüsü: Rastgele koordinatlarda ve farklı yüksekliklerde oluşan yapraklı ağaç sistemleri.
...
Bu yazılımın kodlarının kopyalanması, çoğaltılması veya izinsiz dağıtılması yasaktır.

İhlal durumunda yasal süreç başlatılacaktır.

Bu sürüm "BİLGİSAYAR EDİTİON PRE ALPHA 1.0.0" olarak tescillenmiştir ve değiştirilemez.
